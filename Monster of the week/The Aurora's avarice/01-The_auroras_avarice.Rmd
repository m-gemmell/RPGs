---
title: "The Aurora's Avarice"
author: "Matthew R. Gemmell"
date: "`r Sys.Date()`"
link-citations: yes
favicon: PNGs/aurora.png
cover-image: "PNGs/aurora.png"
---

# The Aurora's Avarice

```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "PNGs/aurora.png", auto_pdf = TRUE)
``` 
...
Except for some who may be able to sell their houses for a high profit in the future.
...
Additionally, they lure the one living Juvenile Ice Worm to their victims with a drone projecting lights like the Aurora Borealis.

This Cult of Skyuss (Ski + Kyuss) has accomplished little by killing road construction workers.
